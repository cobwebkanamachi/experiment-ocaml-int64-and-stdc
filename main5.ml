...
let p = Int64.max_int;;
let p = Int64.logand Int64.max_int (Int64.shift_right_logical Int64.max_int 32);;
let q = Int64.format "%Lx" p;;
print_endline(q);;

let p = Int64.max_int;;
let p = Int64.logand Int64.max_int (Int64.shift_left Int64.max_int 32);;
let q = Int64.format "%Lx" p;;
print_endline(q);;
